  ...
  {#if size < 768}
    ...
    {#if profileDrop}
      <ul class="absolute text-base w-[35%] top-0 right-0 pt-3 pr-8 pl-2 pb-2 flex flex-col justify-end gap-1 bg-white dark:bg-darkbg rounded-lg">
        <a href="/"><li class={`w-fit mx-2 ${$page.url.pathname === "/" ? "text-blue-700 font-semibold" : ""} dark:text-white`}>Home</li></a>
        <a href="/notes"><li class={`w-fit mx-2 ${$page.url.pathname === "/notes" ? "text-blue-700 font-semibold" : ""} dark:text-white`}>Notes</li></a>
        <a href="/tasks"><li class={`w-fit mx-2 ${$page.url.pathname === "/tasks" ? "text-blue-700 font-semibold" : ""} dark:text-white`}>Tasks</li></a>
        <a href="/textEditor"><li class={`w-fit mx-2 ${$page.url.pathname === "/textEditor" ? "text-blue-700 font-semibold" : ""} dark:text-white`}>Text Editor</li></a>
        <a href="/calendar"><li class={`w-fit mx-2 ${$page.url.pathname === "/calendar" ? "text-blue-700 font-semibold" : ""} dark:text-white`}>Calendar</li></a>
        ...
        {#if chevDrop}
          <a href="/tasks"><li class={`w-fit mx-2 ${$page.url.pathname === "/privatedashboard" ? "text-blue-700 font-semibold" : ""} dark:text-white`}>Private Dash</li></a>
          <a href="/tasks"><li class={`w-fit mx-2 dark:text-white`}>Settings</li></a>
          <a href="/tasks"><li class={`w-fit mx-2 dark:text-white`}>Earnings</li></a>
        {/if}
        <li><DarkMode/></li>
